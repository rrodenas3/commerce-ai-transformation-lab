...
| Strict oracle blinding conflicts with publishing the discovery oracle. | A reviewer who reads the repository can learn expected answers. | Public cases are calibration only; future evaluation uses a separately frozen and temporarily sealed oracle, and reviewer exposure is recorded. |
