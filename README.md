...
![Maturity](https://img.shields.io/badge/maturity-foundation%20%7C%20Stage%201%20active-E09F3E)
![Evidence](https://img.shields.io/badge/evidence-research%20%2B%20synthetic-355070)
...
```mermaid
flowchart LR
    A["Business outcome<br/>Verified customer recovery"] --> B["Proposed synthetic current state<br/>8 queues · 7 systems"]
    B --> C["Operating-model redesign<br/>Owners · roles · decision rights"]
    C --> D["Governed AI slice<br/>Evidence · policy · human authority"]
    D --> E["Evaluation<br/>Quality · risk · review burden · cost"]
    E --> F["Enablement<br/>Activator · support · feedback"]
    ...
    classDef outcome fill:#17324d,color:#fff,stroke:#17324d;
    classDef work fill:#edf4f7,color:#17324d,stroke:#6c8ea3;
    classDef decision fill:#f4a261,color:#1f2933,stroke:#c96f27;
    class A outcome;
